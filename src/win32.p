...
create_win32_pipes :: (cmdx: *CmdX, pipes: *Win32_Pipes) {
    ...
    // Do inherit the child side of the pipe
...
try_spawn_process_for_command :: (cmdx: *CmdX, command_name: string) {
    ...
    result := CreateProcessA(null, c_command_name, null, null, inherit_handles, creation_flags, null, c_current_directory, *startup_info, *process);
    if !result {
